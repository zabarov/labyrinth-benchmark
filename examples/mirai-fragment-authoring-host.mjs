...
export async function createParticipant({manifest,cwd}){
  ...
  return createMiraiComposition(manifest,cwd,root,profile,{review:'source',review_strategy:'blind',
    refinement:true,semantic_refinement:true,repair_strategy:'scoped',repair_transport:'target_handles',
    source_transport:'direct_json',fragments:true,repair_preflight:true});
}
