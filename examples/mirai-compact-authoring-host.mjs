...
export async function createParticipant({manifest,cwd}) {
  ...
  return createMiraiComposition(manifest,cwd,root,profile,{review:'source',refinement:true,
    review_strategy:'blind',repair_strategy:'scoped',semantic_refinement:true,
    source_transport:'direct_json',repair_transport:'target_handles'});
}
